...
<body class="body">
        ...
        <nav class="navbar navbar-dark  bg-primary">
            <a class="navbar-brand" href="index.php">
                <img src="img\coche-estacionado.png" width="30" height="30" class="d-inline-block align-top" alt=""
                    loading="lazy">
                Lista de usuarios de pago mensual
            </a>
        </nav>
    </header>
    ...
    $consultasql = "SELECT * FROM mensualidad WHERE contratomensual = 'si'";
                ...
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col mb-4">
                        <div class="card h-100 bordediv">
                            <img src="<?php echo ($mensualidades["foto"])  ?>" class="card-img-top" alt="fotoscard">
                            <div class="card-body">
